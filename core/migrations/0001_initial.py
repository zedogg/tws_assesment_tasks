# Generated by Django 5.0.3 on 2024-07-07 08:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("verified_at", models.CharField(default="True", max_length=200)),
                ("role", models.CharField(default="user", max_length=200)),
                ("status", models.CharField(default="1", max_length=20)),
                (
                    "updated_at",
                    models.CharField(
                        default=datetime.datetime(2024, 7, 7, 8, 53, 47, 682886),
                        max_length=200,
                    ),
                ),
                (
